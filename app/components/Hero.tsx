        ...
        <div className="flex flex-col md:flex-row items-center gap-8 md:gap-12">
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-6 pt-8 max-w-md">
              <div className="bg-white rounded-2xl p-4 shadow-lg shadow-[#4AC4FF]/10">
                <div className="flex items-center gap-2 mb-2">
                  <div className="bg-[#FF4A8D]/10 p-2 rounded-lg">
                    <svg className="w-6 h-6 text-[#FF4A8D]" fill="currentColor" viewBox="0 0 20 20">
              ...
              <div className="bg-white rounded-2xl p-4 shadow-lg shadow-[#4AC4FF]/10">
                <div className="flex items-center gap-2 mb-2">
                  <div className="bg-[#4AC4FF]/10 p-2 rounded-lg">
                    <svg className="w-6 h-6 text-[#4AC4FF]" fill="currentColor" viewBox="0 0 20 20">
          ...
          >
            ...
            {/* Floating Elements */}
            <div className="absolute top-1/4 -left-8 w-16 h-16 bg-[#4AC4FF]/10 rounded-full blur-xl animate-pulse"></div>
            <div className="absolute bottom-1/4 -right-8 w-20 h-20 bg-[#FF9F4A]/10 rounded-full blur-xl animate-pulse delay-1000"></div>
          </motion.div>
        </div>
      </div>
    </section>
